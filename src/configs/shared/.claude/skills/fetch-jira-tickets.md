...
- **JIR-456** [High] Story: Implement LLM retry logic for extensions
- **JIR-789** [Medium] Task: Update API configuration documentation

### ⬚ To Do

- **JIR-123** [High] Bug: urllib3 version conflict in startup
- **JIR-234** [Low] Task: Add unit tests for dynamic extensions
