...
alias gitgraph='/usr/bin/git fetch --all && /usr/bin/git log --all --decorate --graph --oneline'
...
export PATH=$PATH:/opt/dreamtime
export PATH=$PATH:/opt/faceswap
...
# NEVER use same profile as desktop
