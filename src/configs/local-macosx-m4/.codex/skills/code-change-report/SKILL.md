...
description: Use when Codex should produce a concise markdown handoff report that explains important code changes, why they were made, what behavior changed, and what a human engineer should review closely.
---

# Code Change Report

Use this skill when the user wants a compact markdown report that explains the
important code changes in human-review terms.

## Use this skill when

- The user asks what changed and why.
- The user wants an audit or handoff report after implementation.
- The user wants a concise explanation with code blocks.
- The user wants to know what deserves close human review.
...
The report should let the reader answer these questions quickly:

1. What changed?
2. Why did it change?
3. What behavior is different now?
4. What should be reviewed closely?
...
- Include only changes that matter to correctness, behavior, debugging,
...
4. Write the markdown report using the default structure.
