...
from util.shared.fs import path_tools 
...
util_local_path = basedir + "/util/local/"
...
if settings_exists:
    ...
    for _file in settings["libtracklocalutil"]:
        ...
        outpath = lib_path + lib_dir + "/util/" + _file
        path_tools.copy_file_from_to(inpath, outpath)
else:
    generate = raw_input("Local settings file does not exist, copy localsettings.tmpl.json to localsettings.json")
